...
<body>
	...
	<div class="jumbotron feature">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><form action="deleteorder_action.jsp">
                    <center><small><input type="submit"value="Delete Selected Order"></small></center><br/>
                    <center><small><a href="homepage.jsp">Home</a></small></center>
                    </form>
                </h1>
                 </div>
        </div>
